...
- Current visible app version: v2.18.
...
- LTOT now has an FDP lookup workflow: normal short-haul use, Table 1 B/D/X state check, tappable Table 2 for acclimatised crew, and tappable Table 3 for unknown state.
