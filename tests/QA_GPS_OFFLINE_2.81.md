...
- Physical v2.85 testing after a clean Home Screen reinstall confirmed that iPadOS still transformed the live logo during its opening animation. The recording shows the logo displaced at approximately 40.00 seconds and centred by 40.25 seconds. The launch screen itself is correctly sized.
